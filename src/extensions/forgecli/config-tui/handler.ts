...
async function readAvailableModels(sessionRegistry?: import("@earendil-works/pi-coding-agent").ModelRegistry): Promise<{
...
export async function runConfigTui(args: string[], cwd: string, cb: ConfigTuiCallbacks): Promise<number> {
