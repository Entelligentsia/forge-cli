...
import type { PhaseEvidence, SpikeEvidence } from "./spike.js";
...
function runMockChain(steps: ChainStep[], mockOutputs: string[]): MockExecutionResult {
...
export class MockAgentSession {
	 ...
	 */
	populateEvidence(evidence: SpikeEvidence, phaseRecords: PhaseEvidence[], piVersion: string): void {
