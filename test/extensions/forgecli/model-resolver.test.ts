...
function merged(opts: {
	...
	return {
		...
		_global: opts.globalPersonaModels ? { "persona-models": opts.globalPersonaModels } : null,
		_project: opts.projectPersonaModels ? { "persona-models": opts.projectPersonaModels } : null,
